class Vehicle {
    constructor() {
      let name,type,vehicleNumber,employeeId,identification,setCompanyName,setType,setVehicleNumber,setEmployeeId,setIdentification,updatePriceSection,handlePress;
